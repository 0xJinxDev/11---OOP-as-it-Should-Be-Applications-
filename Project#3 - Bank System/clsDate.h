...
private:
	...
	static bool IsLeapYear(_stDate& Date) {
		return ((Date.Year % 400 == 0) || (Date.Year % 4 == 0 && Date.Year % 100 != 0));
	}


	static short DaysInAMonth(_stDate& Date) {
...
public:
	...
	static bool IsDate1BeforeDate2(const clsDate& Date1, const clsDate& Date2) {
		...
		return (Date1._Date.Year < Date2._Date.Year) ||
			(Date1._Date.Year == Date2._Date.Year && Date1._Date.Month < Date2._Date.Month) ||
			(Date1._Date.Year == Date2._Date.Year && Date1._Date.Month == Date2._Date.Month && Date1._Date.Day < Date2._Date.Day)
			;
	}

	static bool IsDate1EqualsDate2(const clsDate& Date1, const clsDate& Date2) {
		return !IsDate1BeforeDate2(Date1, Date2) &&
			!IsDate1BeforeDate2(Date2, Date1);
